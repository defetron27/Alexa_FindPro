                            ...
                            if (taskName.equals("find a object in video"))
                            {
                                try (VideoIntelligenceServiceClient client = VideoIntelligenceServiceClient.create())
                                {
                                    ...
                                    if (count > 0)
                                    {
                                        ...
                                        Map<String, Object> searchObjectExtractDataSource = getDirectivesResponse("class", JsonHelper.convertTaskResult("FIND A OBJECT",screenBuilder.toString()));
                                    ...
                                    {
                                        String roundTitle = "find a<br>object";

                                        String title = "find a object";
                                        ...
                                        return getSimpleResponsePrompt(input,roundTitle,title,message,rePrompt,session);
                                    }
                                }
