...
public class ShowTheTaskMenuIntentRequestHandler implements RequestHandler
{
    ...
    public Optional<Response> handle(HandlerInput input)
    {
        if (Util.supportsApl(input))
        {
            ...
            Map<String, Object> fallbackDocument = getDirectivesResponse("file","fallbackIntent.json");

            Map<String, Object> fallbackDataSource = getDirectivesResponse("file","fallbackIntentTemplateData.json");
