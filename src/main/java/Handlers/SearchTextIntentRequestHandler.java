                            ...
                            if (taskName.equals("find a text in video"))
                            {
                                try (VideoIntelligenceServiceClient client = VideoIntelligenceServiceClient.create())
                                {
                                    ...
                                    if (count > 0)
                                    {
                                        ...
                                        Map<String, Object> videoTextExtractDataSource = getDirectivesResponse("class", JsonHelper.convertTaskResult("FIND A TEXT<br>IN VIDEO TASK RESULT",screenBuilder.toString()));
