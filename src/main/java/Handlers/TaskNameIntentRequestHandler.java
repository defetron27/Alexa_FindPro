                        ...
                        if (taskName != null)
                        {
                            ...
                            if (taskName.equals("image text extract"))
                            {
                                ...
                                String message = "Okay, you choose image text extract task. " +
                                        "This task is useful to extract the detected texts from the image. " +
                                        sMessage;
                            ...
                            else if (taskName.equals("image object extract"))
                            {
                                ...
                                String message = "Okay, you choose image object extract task. " +
                                        "This task is useful to extract the detected objects from the image. " +
                                        sMessage;
                            ...
                            {
                                String roundTitle = "video text<br>extract task";

                                String message = "Okay, you choose video text extract task. " +
                                        "This task is useful to extract the detected texts from the video. " +
                                        sMessage;
                            ...
                            {
                                String roundTitle = "video object<br>extract task";

                                String message = "Okay, you choose video object extract task. " +
                                        "This task is useful to extract the detected objects from the video. " +
                                        sMessage;
