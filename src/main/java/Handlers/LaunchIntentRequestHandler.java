...
import static Utils.Util.getSimpleResponsePrompt;
    ...
    public Optional<Response> handle(HandlerInput input)
    {
        if (Util.supportsApl(input))
        {
            String message = "Hi, welcome to finder pro. " +
                    ...
                    "If you don't know what task i will do, simple say show the task menu. " +
                    "Otherwise say the task name with keyword task name. ";

            String rePrompt = "If you don't know what task i will do, simple say show the task menu. " +
                    "Otherwise say the task name with keyword task name. ";
            ...
            return getSimpleResponsePrompt(input,title,title,message,rePrompt,session);
        }
        else
        {
