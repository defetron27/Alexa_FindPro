...
public class Util
{
    ...
    public static Optional<Response> getFallbackResponse(HandlerInput input, Map<String, Object> fallbackDocument, Map<String, Object> fallbackDataSource)
    {
    ...
    public static Map<String, Object> fallbackDocument = getDirectivesResponse("file","fallbackIntent.json");

    public static Map<String, Object> fallbackDataSource = getDirectivesResponse("file","fallbackIntentTemplateData.json");

    public static Optional<Response> getSimpleResponse(HandlerInput input,String roundTitle, String title, String message, Map<String,Object> session)
    {
        AttributesManager attributesManager = input.getAttributesManager();
    ...
    public static Optional<Response> getSimpleResponsePrompt(HandlerInput input,String roundTitle, String title, String message, String prompt, Map<String,Object> session)
    {
        AttributesManager attributesManager = input.getAttributesManager();
